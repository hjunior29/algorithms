      ...
      <section class="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
        ...
        <div class="relative z-10 text-center max-w-4xl mx-auto">
          <div class="flex items-center justify-center gap-4 mb-8">
            <img src="/images/logo.png" alt="Logo" class="w-16 h-16 sm:w-20 sm:h-20" />
          </div>
          ...
          <p class="text-lg sm:text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
      ...
      <section class="py-20 px-4 bg-gray-800/50">
        <div class="max-w-6xl mx-auto">
          ...
          <div class="grid md:grid-cols-3 gap-8">
            <div class="hover-3d">
              <div class="card bg-gray-800 border border-gray-700 h-full">
                <div class="card-body">
                  ...
                  <h3 class="card-title text-white">Learn Visually</h3>
                  <p class="text-gray-400">See exactly how each algorithm processes data, making complex logic easy to understand.</p>
                </div>
              </div>
            ...
            <div class="hover-3d">
              <div class="card bg-gray-800 border border-gray-700 h-full">
                <div class="card-body">
                  ...
                  <h3 class="card-title text-white">Compare Performance</h3>
                  <p class="text-gray-400">Track operations and execution time to understand the efficiency of different approaches.</p>
                </div>
              </div>
              <div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div>
            </div>
            ...
            <div class="hover-3d">
              <div class="card bg-gray-800 border border-gray-700 h-full">
                <div class="card-body">
                  ...
                  <h3 class="card-title text-white">Interactive Controls</h3>
                  <p class="text-gray-400">Adjust speed, array size, and values in real-time to explore different scenarios.</p>
                </div>
              </div>
              <div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div>
            </div>
        ...
        <div class="max-w-6xl mx-auto">
          ...
          <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <a href="/run?algorithm=insertion" class="hover-3d">
              <div class="card bg-gradient-to-br from-blue-900/50 to-gray-800 border border-blue-500/20">
                <div class="card-body">
                  <div class="badge badge-primary mb-2">O(n²)</div>
                  <h3 class="card-title text-white">Insertion Sort</h3>
                  <p class="text-gray-400 text-sm">Builds the sorted array one element at a time. Efficient for small or nearly sorted data.</p>
                </div>
              </div>
              <div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div>
            </a>
            ...
            <a href="/run?algorithm=selection" class="hover-3d">
              <div class="card bg-gradient-to-br from-green-900/50 to-gray-800 border border-green-500/20">
                <div class="card-body">
                  <div class="badge badge-success mb-2">O(n²)</div>
                  <h3 class="card-title text-white">Selection Sort</h3>
                  <p class="text-gray-400 text-sm">Repeatedly finds the minimum element and moves it to the sorted portion.</p>
                </div>
              </div>
              <div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div>
            </a>
            ...
            <a href="/run?algorithm=bubble" class="hover-3d">
              <div class="card bg-gradient-to-br from-yellow-900/50 to-gray-800 border border-yellow-500/20">
                <div class="card-body">
                  <div class="badge badge-warning mb-2">O(n²)</div>
                  <h3 class="card-title text-white">Bubble Sort</h3>
                  <p class="text-gray-400 text-sm">Repeatedly swaps adjacent elements if they are in the wrong order.</p>
                </div>
              </div>
              <div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div>
            </a>
            ...
            <a href="/run?algorithm=shell" class="hover-3d">
              <div class="card bg-gradient-to-br from-purple-900/50 to-gray-800 border border-purple-500/20">
                <div class="card-body">
                  <div class="badge badge-secondary mb-2">O(n log n)</div>
                  <h3 class="card-title text-white">Shell Sort</h3>
                  <p class="text-gray-400 text-sm">Generalization of insertion sort that allows exchange of far apart elements.</p>
                </div>
              </div>
              <div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div>
            </a>
            ...
            <a href="/run?algorithm=merge" class="hover-3d">
              <div class="card bg-gradient-to-br from-cyan-900/50 to-gray-800 border border-cyan-500/20">
                <div class="card-body">
                  <div class="badge badge-info mb-2">O(n log n)</div>
                  <h3 class="card-title text-white">Merge Sort</h3>
                  <p class="text-gray-400 text-sm">Divide and conquer algorithm that splits, sorts, and merges arrays.</p>
                </div>
              </div>
              <div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div>
            </a>
            ...
            <a href="/run?algorithm=heap" class="hover-3d">
              <div class="card bg-gradient-to-br from-red-900/50 to-gray-800 border border-red-500/20">
                <div class="card-body">
                  <div class="badge badge-error mb-2">O(n log n)</div>
                  <h3 class="card-title text-white">Heap Sort</h3>
                  <p class="text-gray-400 text-sm">Uses a binary heap data structure to sort elements efficiently.</p>
                </div>
              </div>
              <div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div>
            </a>
            ...
            <a href="/run?algorithm=quick" class="hover-3d">
              <div class="card bg-gradient-to-br from-orange-900/50 to-gray-800 border border-orange-500/20">
                <div class="card-body">
                  <div class="badge badge-warning mb-2">O(n log n)</div>
                  <h3 class="card-title text-white">Quick Sort</h3>
                  <p class="text-gray-400 text-sm">Fast divide and conquer using a pivot element to partition arrays.</p>
                </div>
              </div>
              <div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div>
            </a>
            ...
            <a href="/run?algorithm=quick3" class="hover-3d">
              <div class="card bg-gradient-to-br from-pink-900/50 to-gray-800 border border-pink-500/20">
                <div class="card-body">
                  <div class="badge badge-secondary mb-2">O(n log n)</div>
                  <h3 class="card-title text-white">Quick3 Sort</h3>
                  <p class="text-gray-400 text-sm">3-way partitioning variant, excellent for arrays with many duplicates.</p>
                </div>
              </div>
              <div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div>
            </a>
